...
<pre>script/plugin install git://github.com/captproton/subdomain-fu.git</pre>

For a GemPlugin, add this dependency to your @environment.rb@:

<pre>config.gem 'captproton-subdomain-fu', :source => "http://gems.github.com/", :lib => "subdomain-fu"</pre>
...
updates, "is available on GitHub":http://github.com/captproton/subdomain-fu/ as always, and bugs/feature requests may
be passed on through the "Lighthouse":http://captproton.lighthouseapp.com/projects/13148-subdomain-fu.

...
<pre name='code'>script/plugin install git://github.com/captproton/twitter-auth.git</pre>
...
Once you've migrated, that's it! You are up and running with Twitter authentication; just point users at <code>/login</code> to start the process (login and registration are handled in a single step). For more detailed usage information including how to access the Twitter API through TwitterAuth, take a look at "the README file":http://github.com/captproton/twitter-auth.

The source for TwitterAuth is "available on GitHub":http://github.com/captproton/twitter-auth. I have also created a "Lighthouse Project":http://captproton.lighthouseapp.com/projects/27783-twitterauth for the reporting of any bugs you may come across. There is also a "basic homepage":http://captproton.com/twitter-auth/ that will be listing who's using TwitterAuth.

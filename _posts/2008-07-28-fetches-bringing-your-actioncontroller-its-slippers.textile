...
<pre name="code" class="ruby">config.gem 'captproton-fetches', :source => 'http://gems.github.com', :lib => "fetches"</pre>
  
To install it as a traditional plugin:

<pre><code>script/plugin install git://github.com/captproton/fetches.git</pre>

h3. Resources

The source is "available on GitHub":http://github.com/captproton/fetches, the "Acts As Community project":http://actsascommunity.com/projects/fetches is there for general discussion, and "the Lighthouse":http://captproton.lighthouseapp.com/projects/14793-fetches/overview is there for bugs and feature suggestions.

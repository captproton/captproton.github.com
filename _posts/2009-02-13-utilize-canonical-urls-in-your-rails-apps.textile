...
<pre name='code' class='ruby'>config.gem 'captproton-canonical-url', :source => 'http://gems.github.com', :lib => 'canonical_url'</pre>
...
The source for the plugin is "available on GitHub":http://github.com/captproton/canonical-url. So go forth and canonize your applications!

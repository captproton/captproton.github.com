...
config.gem "captproton-acts-as-taggable-on", :source => "http://gems.github.com", :lib => "acts-as-taggable-on"</pre>
...
Let's say I have a plugin called <code>awesome_fu</code> that lives on GitHub at <code>captproton/awesome-fu</code>. I've already released this plugin, it works great, and now I want to make it compatible with GemPlugins.

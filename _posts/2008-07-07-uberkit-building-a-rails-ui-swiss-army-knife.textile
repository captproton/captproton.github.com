...
<pre name="code" class="ruby">config.gem 'captproton-uberkit', :source => "http://gems.github.com/", :lib => "uberkit"</pre>

Or as a traditional plugin:

<pre><code>script/plugin install git://github.com/captproton/uberkit.git</pre>
...
As always, the "source is on GitHub":http://github.com/captproton/uberkit and there is an "Acts As Community Profile":http://www.actsascommunity.com/projects/uberkit available as well. If you have any problems with it or would like to request new features, "enter them on the Lighthouse project":http://captproton.lighthouseapp.com/projects/13921-uberkit/overview.